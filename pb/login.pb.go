...
var file_proto_login_proto_rawDesc = []byte{
	...
	0x6c, 0x74, 0x32, 0x42, 0x0a, 0x05, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12, 0x39, 0x0a, 0x0d, 0x45,
	0x6d, 0x61, 0x69, 0x6c, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x69, 0x6e, 0x67, 0x12, 0x13, 0x2e, 0x70,
...
var file_proto_login_proto_depIdxs = []int32{
	0, // 0: proto.Login.EmailChecking:input_type -> proto.LoginRequest
	1, // 1: proto.Login.EmailChecking:output_type -> proto.LoginReply
...
func (c *loginClient) EmailChecking(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginReply, error) {
	out := new(LoginReply)
	err := c.cc.Invoke(ctx, "/proto.Login/EmailChecking", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedLoginServer) EmailChecking(context.Context, *LoginRequest) (*LoginReply, error) {
...
func _Login_EmailChecking_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Login/EmailChecking",
	}
